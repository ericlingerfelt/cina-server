 ...
 * $Id: read_time_data.c,v 1.3 2008/07/17 15:37:28 bucknerk Exp $
 *
 * $Log: read_time_data.c,v $
 * Revision 1.3  2008/07/17 15:37:28  bucknerk
 ...
 *
 * Revision 1.2  2008/03/26 20:08:15  bucknerk
 ...
 * Visualizer into time steps that can be used with the waiting point code. The
...
int main(int argc, char **argv)
{
  ...
  if(time && temp) {
    ...
    //for(i=0;i<val;i++) printf("%d -- %0.6E\n",time[i].step,time[i].time);
    }
  printf("%d,%d\n",steps[0],steps[1]);
  return 0;
}
