...
!     Write(50,"(a)") " i      pt   iparm" 
!     Write(50,"(i2,2i8)") (i,pt(i),iparm(i),i=1,64)
...
! Comment this block for non-MKL PARDISO
     ...
     &                iparm,msglvl,f,dy,err)
          ...
          Write(50,*) 'PARDISO Memory Free',err, kstep, kts, knr, knrcut
        Endif
